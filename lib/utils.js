...
const utils = {
  ...
  /**
   * Generates id for a GasData.deployments entry from the input of a contract name and
   * and bytecode
   * @param  {String} code hex data
   * @return {String}      id
   */
  getDeploymentID: function(contractName, bytecode) {
    return contractName + "_" + bytecode.slice(2, 10);
  },
